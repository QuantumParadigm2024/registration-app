...
//                                 navigate("/book-demo");
//                             }}
//                             className="w-full bg-red-600 text-white py-2.5 rounded-lg text-sm font-medium flex items-center justify-center gap-2"
//                         >
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8">
                    {navLinks.map((link) => (
                        <Link
                            key={link.path}
                            to={link.path}
                            className={`text-sm font-medium transition-all duration-300 relative after:absolute after:-bottom-1 after:left-0 after:h-0.5 after:bg-red-600 after:transition-all after:duration-300 ${location.pathname === link.path
                                    ? "text-red-600 after:w-full"
                                    : "text-gray-600 after:w-0 hover:text-gray-900 hover:after:w-full"
                                }`}
                        >
                ...
                <div className="hidden md:flex items-center gap-3">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => navigate("/login")}
                        className="bg-white border border-gray-300 text-gray-700 px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-50 transition-all shadow-sm"
                    >
                        Get Started
                    </motion.button>
                    <motion.button
                        ...
                        className="bg-red-600 text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-red-700 transition-all shadow-md flex items-center gap-2"
                    >
                        <i className="fas fa-calendar-alt"></i>
                        Book a Demo
                    </motion.button>
                    ...
                    <div className="container mx-auto px-4 py-4 space-y-3">
                        {navLinks.map((link) => (
                            <Link
                                ...
                                to={link.path}
                                onClick={() => setIsMenuOpen(false)}
                                className={`block text-sm font-medium py-2 ${location.pathname === link.path
                                        ? "text-red-600"
                                        : "text-gray-600 hover:text-gray-900"
                                    }`}
                            >
                        ...
                        <button
                            ...
                            className="w-full bg-white border border-gray-300 text-gray-700 py-2.5 rounded-lg text-sm font-medium mt-2"
                        >
                            Get Started
                        </button>
                        <button
